...
class TVController extends Controller
{
    public function index(){
        ...
        return view('back.tvchannel.index',compact(['channels']));
    }
    ...
    public function store(){
        ...
        return view('back.tvchannel.create',compact(['languages','countries']));
    }
    ...
    public function edit($id){
        ...
        return view('back.tvchannel.edit',compact(['languages','countries','id','channel','channel_contents']));
    }
